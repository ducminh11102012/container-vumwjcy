...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-vumwjcy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-vumwjcy.containers.anotherwebservice.com/
...
```
git clone git@github.com:ducminh11102012/container-vumwjcy.git
cd container-vumwjcy
```
...
```
docker attach container-vumwjcy
```
